...
const OutsideClickContext = /*#__PURE__*/React__default['default'].createContext({});
...
function OutsideClickGroupProvider({
  ...
  const isPartOfGroup = typeof React__default['default'].useContext(OutsideClickContext) === "function";

  if (isPartOfGroup) {
    return children;
  }

  return /*#__PURE__*/React__default['default'].createElement(OutsideClickContext.Provider, {
    value: React__default['default'].useCallback(layerRef => {
...
function useRegisterGroup(refs) {
  const registerRefToGroup = React__default['default'].useContext(OutsideClickContext);
...
function useOutsideClick(refs, callback) {
  const [events] = React__default['default'].useState(["click"]);
  useRegisterGroup(refs);
  useEvent(typeof document !== "undefined" ? document : null, events, React__default['default'].useCallback(evt => {
...
const ToggleLayer = ({
  ...
  }), relativeParentElement && /*#__PURE__*/React.createElement(OutsideClickGroupProvider, {
    refs: outsideClickRefs
  }, /*#__PURE__*/reactDom.createPortal(renderLayer({
    layerProps: {
      ref: element => {
        if (element) {
...
function useToggleLayer(renderLayer, {
  ...
  const element = relativeParentElement && /*#__PURE__*/reactDom.createPortal(renderLayer({
    layerProps: {
      ref: element => {
        if (element) {
          // observe the layer for resizing
  ...
  return [/*#__PURE__*/React.createElement(OutsideClickGroupProvider, {
    refs: outsideClickRefs
  }, element), payload];
}
