...
describe('Editor', function () {
  describe('renders the Editor', function () {
    ...
    it('without the defaultKeyBindings and defaulteyCommands plugin if deactivated', function () {
      var result = (0, _enzyme.mount)(_react2.default.createElement(_index2.default, {
        editorState: editorState,
        onChange: changeSpy,
  ...
  describe('with plugins', function () {
    ...
    it('calls the handle-hooks of the plugin', function () {
      ...
      (0, _chai.expect)(plugin.handleKeyCommand).has.been.calledWith('command', editorState, expectedSecondArgument);
