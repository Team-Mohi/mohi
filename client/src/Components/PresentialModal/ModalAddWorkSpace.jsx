...
function ModalAddWorkSpace({ profile }) {
    ...
    const onSubmit = (data) => {
        ...
        .then(res => {
          dispatch(responseAddInfoProfile({type: 'user_workPlace', value: data.user_workPlace}))
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="modal-add-work-space-main">
                        <div className="modal-add-work-space-main-input">
                            ...
                            <input type="text" name="user_workPlace" id="" placeholder="Nhập nơi làm việc..." ref={register} />
                        </div>
                    </div>
