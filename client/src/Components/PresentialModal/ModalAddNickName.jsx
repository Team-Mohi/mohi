...
function ModalAddNickName({ profile }) {
    ...
    const onSubmit = (data) => {
        ...
        editInfo({type: 'user_nick_name', value: data.user_nick_name})
        .then(res => {
          dispatch(responseAddInfoProfile({type: 'user_nick_name', value: data.user_nick_name}))
        ...
        <React.Fragment>
            <div className="modal-custom modal-add-work-space">
                <div className="modal-add-work-space-header">
                    Thêm một biệt danh hoặc tên khai sinh của bạn
                </div>
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="modal-add-work-space-main">
                        <div className="modal-add-work-space-main-input">
                            <label htmlFor="">Tên khai sinh hoặc biệt hiệu</label>
                            <input type="text" name="user_nick_name" id="" placeholder="Nhập tên khai sinh hoặc biệt hiệu bạn..." ref={register} />
                        </div>
                    </div>
...
export default ModalAddNickName;
