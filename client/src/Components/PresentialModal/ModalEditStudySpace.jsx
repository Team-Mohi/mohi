...
function ModalEditStudySpace({ presentialModal, profile }) {
    ...
    const onSubmit = (data) => {
        ...
        editInfo({type: 'user_studyPlace', value: data.user_studyPlace})
        .then(res => {
          dispatch(responseUpdateProfile({type: 'user_studyPlace', value: data.user_studyPlace}))
        ...
        <React.Fragment>
            <div className="modal-custom modal-add-work-space">
                <div className="modal-add-work-space-header">
                    Chỉnh sửa nơi học tập
                </div>
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="modal-add-work-space-main">
                        <div className="modal-add-work-space-main-input">
                            <label htmlFor="">Nơi học</label>
                          <input type="text" name="user_studyPlace" id="" defaultValue={statusPresentialModal.data} ref={register} />
                        </div>
...
export default ModalEditStudySpace;
