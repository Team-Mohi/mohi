...
function ModalEditNickName({ presentialModal, profile }) {
    ...
    const onSubmit = (data) => {
        ...
        .then(res => {
          dispatch(responseUpdateProfile({type: 'user_nick_name', value: data.user_nick_name}))
        ...
        <React.Fragment>
            <div className="modal-custom modal-add-work-space">
                <div className="modal-add-work-space-header">
                    Chỉnh sửa biệt danh hoặc tên khai sinh của bạn
                </div>
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="modal-add-work-space-main">
                        <div className="modal-add-work-space-main-input">
                            <label htmlFor="">Biệt danh hoặc tên khai sinh của bạn</label>
                          <input type="text" name="user_nick_name" id="" defaultValue={statusPresentialModal.data} ref={register} />
                        </div>
